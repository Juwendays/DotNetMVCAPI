#pragma checksum "C:\Users\Alvin Juweda\source\repos\HttpClient\MVCClient-main\MVCClient\Views\Shared\Argon\_Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bf7e350b7640e764b1395186a9001d99792d054d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Argon__Index), @"mvc.1.0.view", @"/Views/Shared/Argon/_Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bf7e350b7640e764b1395186a9001d99792d054d", @"/Views/Shared/Argon/_Index.cshtml")]
    ...
    public class Views_Shared_Argon__Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral(@"<div class=""w-full px-6 py-6 mx-auto"">
    <!-- table 1 -->
                    ...
                    <div class=""p-0 overflow-x-auto"">
                        <table class=""items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500"">
                            <thead class=""align-bottom"">
                                <tr>
                                    <th class=""px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-");
            WriteLiteral(@"collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70"">Author</th>
  ...
  ");
            WriteLiteral(@"                                  <th class=""px-6 py-3 font-semibold capitalize align-middle bg-transparent border-b border-collapse border-solid shadow-none dark:border-white/40 dark:text-white tracking-none whitespace-nowrap text-slate-400 opacity-70""></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <div class=""flex px-2 py-1"">
                                            ...
                                            <div class=""fl");
            WriteLiteral(@"ex flex-col justify-center"">
                                    ...
                                    <td class=""p-2 text-sm leading-normal text-center align-midd");
            WriteLiteral(@"le bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                    ...
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <a href=""javascript:;"" class=""text-xs font-semibold leading-tight dark:text-white dark:opacity");
            WriteLiteral(@"-80 text-slate-400""> Edit </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <div class=""flex px-2 py-1"">
                                            ...
                                            <div class=""flex flex-col justify-center"">
                                                ...
                                                <p class=""mb-0 text-xs leading-tight dark:text-white dark:opa");
            WriteLiteral(@"city-80 text-slate-400"">alexa@creative-tim.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                    ...
                                    <td class=""p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <span class=""bg-gradient-to-tl from-slate-600 to-slate-300 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-cen");
            WriteLiteral(@"ter align-baseline font-bold uppercase leading-none text-white"">Offline</span>
                                    </td>
                                    <td class=""p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                ...
                                <tr>
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40");
            WriteLiteral(@" whitespace-nowrap shadow-transparent"">
                                        <div class=""flex px-2 py-1"">
                                            <div>
                                    ...
                                    <td class=""p-2 align-mi");
            WriteLiteral(@"ddle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                    ...
                                    <td class=""p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-no");
            WriteLiteral(@"wrap shadow-transparent"">
                                ...
                                <tr>
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <div class=""flex px-2 py-1"">
                                            <div>
                                                <img src=""../assets/img/team-3.jpg"" class=""inli");
            WriteLiteral(@"ne-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-in-out h-9 w-9 rounded-xl"" alt=""user4"" />
                                            </div>
                                            <div class=""flex flex-col justify-center"">
                                    ...
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <p class=""mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-80"">Programator</p>
                             ");
            WriteLiteral(@"           <p class=""mb-0 text-xs leading-tight dark:text-white dark:opacity-80 text-slate-400"">Developer</p>
                                    </td>
                                    <td class=""p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <span class=""bg-gradient-to-tl from-emerald-500 to-teal-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white"">Online</span>
                                    </td>
                                 ...
                                 ");
            WriteLiteral(@"   <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <a href=""javascript:;"" class=""text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400""> Edit </a>
                                    </td>
                                </tr>
                                <tr>
            ...
            WriteLiteral(@" justify-center"">
                                    ...
                                    <td class=""p-2 text-sm leading-normal text-center align-middle bg-trans");
            WriteLiteral(@"parent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                    ...
                                    <td class=""p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent"">
                                        <a href=""javascript:;"" class=""text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-sl");
            WriteLiteral(@"ate-400""> Edit </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class=""p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent"">
                                        <div class=""flex px-2 py-1"">
                                            ...
                                            <div class=""flex flex-col justify-center"">
                                                ...
                                                <p class=""mb-0 text-xs leading-tight dark:text-white dark:opacity-80 text-slate-400"">miriam");
            WriteLiteral(@"@creative-tim.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class=""p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent"">
                                    ...
                                    <td class=""p-2 text-sm leading-normal text-center align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent"">
                                        <span class=""bg-gradient-to-tl from-slate-600 to-slate-300 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white"">Offl");
